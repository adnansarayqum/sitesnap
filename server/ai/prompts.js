...
- Third person, past tense, court-facing. "was observed … at the time of inspection" for observations. A causal sentence opens "On the balance of probabilities, …" and states the cause as "is attributable to" — only where the causation confidence is medium or high. Where a finding carries several causal statements, open the first with that phrase and later ones with "Furthermore, …" or "In addition, …" rather than repeating it each sentence. Opinion is labelled as opinion ("in my opinion", "is considered to be").
